// ======================================================
// FILE: screens/cook/CookProfileScreen.js
// OUR PROJECT - NUTRIDIET / HEALTHY FOOD APP
// ======================================================
...
export default function CookProfileScreen({
  ...
  const [cookData, setCookData] =
    useState({
      ...
      description:
        'Professional home chef specialized in healthy diet meals, weight loss foods, diabetic-friendly meals and protein-rich recipes.',
